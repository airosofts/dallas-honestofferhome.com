    ...
    <>
      ...
      <header className="topbar">
        <div className="container-site topbar-inner">
          <Link href="/" className="brand" aria-label="Honest Offer — We Buy Houses in Texas">
      ...
      <section>
        <div className="container-site">
          <div className="section-head centered">
            ...
            <h2>Straight answers for Texas homeowners.</h2>
          </div>
        ...
        <div className="container-site">
          <div className="foot-grid">
            <div className="foot foot-brand">
              ...
              <p>Straight-talk cash offers on houses across Texas. Locally owned, family-operated, licensed and insured.</p>
            ...
            <div className="foot">
              <h5>We Buy Houses</h5>
              <ul>
                <li><Link href="/">Dallas, TX</Link></li>
                <li><Link href="/louisville-ky">Louisville, TX</Link></li>
                <li><Link href="/bowling-green-ky">Bowling Green, TX</Link></li>
                <li>All of Texas</li>
              </ul>
            </div>
            <div className="foot">
              ...
              <ul>
                ...
                <li><Link href="/sell-house-as-is-texas">Any condition</Link></li>
              </ul>
            </div>
            <div className="foot">
              <h5>About</h5>
