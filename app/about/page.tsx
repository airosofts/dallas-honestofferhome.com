...
export const metadata: Metadata = {
  title: "About Honest Offer | Locally Owned Texas Cash Home Buyer",
  description:
    "Honest Offer is a locally owned Texas real estate company. We buy houses for cash across Dallas, Louisville, Bowling Green, and all of Texas. A+ BBB rated.",
  alternates: { canonical: "https://dallas.honestofferhome.com/about" },
    ...
    <>
      ...
      <section className="hero" style={{ paddingBottom: "clamp(40px, 6vw, 80px)" }}>
        <div className="container-site">
          <div className="eyebrow">Locally owned · Texas</div>
          <h1 style={{ maxWidth: "20ch" }}>
            We&rsquo;re not a national brand. We&rsquo;re a <em>Texas team.</em>
          </h1>
          <p className="hero-sub" style={{ maxWidth: "62ch" }}>
            Honest Offer is a locally owned real estate company that buys houses for cash across Texas. We&rsquo;ve been doing this for over seven years, and we&rsquo;ve bought more than 200 homes — mostly the ones that traditional buyers won&rsquo;t touch.
          </p>
        </div>
      </section>
      ...
      <section>
        <div className="container-site about-grid">
          <div className="about-copy">
            ...
            <p>
              That&rsquo;s not a marketing line — it&rsquo;s the only way the business works long-term. We&rsquo;re a small team, and our reputation in Texas is what keeps the phone ringing. We can&rsquo;t afford to be the kind of buyer who makes sellers regret picking up the phone.
            </p>
          </div>
          <div className="local-card">
            ...
            <div className="local-stat"><span className="l">States we operate in</span><span className="v">Texas</span></div>
          ...
          <div className="sit-grid">
            {[
              ...
              },
              {
                ...
                body: "We pay all Texas closing costs. We charge no service fee. The written offer is the wire amount — no deductions at the title company, no surprise line items.",
              },
            ].map((v, i) => (
      ...
      <section>
        <div className="container-site">
          <div className="section-head">
            ...
            <h2>We buy throughout Texas — not just the big cities.</h2>
            <p className="muted" style={{ maxWidth: "60ch" }}>
              Our core markets are Dallas, Louisville, and Bowling Green, but we buy houses in every corner of the state — rural counties, small towns, large parcels. If you&rsquo;re in Texas, give us a call.
            </p>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "0.75rem", marginTop: "2rem" }}>
            {["Dallas", "Louisville", "Bowling Green", "Georgetown", "Nicholasville", "Richmond", "Winchester", "Elizabethtown", "Frankfort", "Owensboro", "Covington", "Florence"].map(city => (
      ...
      <section className="final-cta">
        <div className="container-site final-cta-inner">
          ...
          <h2>Ready to see what we&rsquo;d pay for your <em>Texas home?</em></h2>
