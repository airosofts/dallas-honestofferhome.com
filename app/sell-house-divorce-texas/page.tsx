...
export const metadata: Metadata = {
  title: "Sell House During Divorce in Texas | Fast Closing | Honest Offer",
  description:
    "Need to sell a house during a divorce in Texas? We close fast, split the proceeds cleanly, and keep the process private. Cash offer in 24 hours. No agents, no delays.",
  alternates: { canonical: "https://dallas.honestofferhome.com/sell-house-divorce-texas" },
...
const FAQ: FaqItem[] = [
  ...
  },
  {
    ...
    a: "In most cases, yes. Both spouses have legal authority to sell jointly-owned property before a Texas divorce decree is issued, though some courts issue temporary orders restricting transfers — your attorney will know if that applies to your case. We've closed plenty of sales before a divorce was final.",
  },
  {
...
export default function Page() {
  return (
    <SituationLayout
      brandTagline="Divorce Sales · Texas"
      heroEyebrow="Private · Fast · Clean split"
      headline={<>Sell Your House During a <em>Divorce</em> in Texas — Fast and Private</>}
      ...
      detailEyebrow="Selling a house during a Texas divorce?"
      ...
      detailParagraphs={[
        ...
        "We've worked with divorce attorneys and mediators across Texas and understand what a court-ordered or agreed-upon sale looks like. We can close in as little as 7 days, or schedule out 60–90 days if the proceedings require it.",
      ]}
      faqItems={FAQ}
      ctaHeadline={<>Get a <em>private, fast</em> offer on your Texas home today.</>}
    />
  );
}
