...
export const metadata: Metadata = {
  title: "How It Works | Sell Your House for Cash in Texas | Honest Offer",
  description:
  ...
  alternates: { canonical: "https://dallas.honestofferhome.com/how-it-works" },
        ...
        <div className="container-site">
          {[
            ...
            },
            {
              ...
              body: [
                "We hire a Texas title company to run the title search. This is where they look for any liens, unpaid taxes, judgments, or ownership questions that need to be resolved before we can close. This usually takes 7–14 days.",
      ...
      <section style={{ background: "var(--cream-deep)", padding: "clamp(48px, 8vw, 96px) 0" }}>
        <div className="container-site hero-grid">
          <div>
            ...
            <h2>Ready to see what we&rsquo;d pay for your Texas house?</h2>
