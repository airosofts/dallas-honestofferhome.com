...
export const metadata: Metadata = {
  title: "Sell Your House Fast in Texas | Cash Offer in 24 Hours | Honest Offer",
  description:
    "Need to sell your Texas house fast? We buy houses statewide and close in as little as 7 days. No repairs, no agents, no fees. Fair written cash offer in 24 hours.",
  alternates: { canonical: "https://dallas.honestofferhome.com/sell-house-fast-texas" },
  robots: { index: true, follow: true },
};

const FAQ: FaqItem[] = [
  {
    q: "How fast can you actually close on a Texas house?",
  ...
  {
    q: "Do you buy in smaller Texas towns and rural areas, not just DFW?",
    a: "Yes. We buy throughout Texas — not just Dallas–Fort Worth, Houston, Austin, and San Antonio. East Texas, Hill Country, the Panhandle, rural counties, smaller towns, properties on large parcels. Call us with the address and we'll tell you quickly if it's in our buying range.",
  },
];
...
export default function Page() {
  return (
    <SituationLayout
      brandTagline="Sell Fast · All of Texas"
      heroEyebrow="Locally owned · Close in 7–21 days · $0 fees"
      headline={<>Sell Your House Fast in <em>Texas</em> — Written Offer in 24 Hours</>}
      heroIntro="Whether you need to close in 7 days or simply want certainty that the sale will happen, we're the fastest path to a clean, hassle-free close in Texas. We buy houses statewide — any condition, any situation, any timeline. No repairs, no agents, no fees."
      ...
      detailParagraphs={[
        ...
        "We're locally owned in Texas. We buy throughout the state — Dallas, Fort Worth, Houston, Austin, San Antonio, and everywhere in between, including smaller towns and rural counties. If you're in Texas and need to sell, we can usually make you an offer.",
      ]}
      faqItems={FAQ}
      ctaHeadline={<>Get a written cash offer on your <em>Texas house</em> today.</>}
    />
  );
}
