...
export const metadata: Metadata = {
  title: "Sell House As-Is in Texas | No Repairs Needed | Honest Offer",
  description:
    "Sell your Texas house as-is — no repairs, no cleaning, no staging. We buy homes in any condition across Texas. Fair cash offer in 24 hours. A+ BBB rated.",
  alternates: { canonical: "https://dallas.honestofferhome.com/sell-house-as-is-texas" },
...
export default function Page() {
  return (
    <SituationLayout
      brandTagline="As-Is Home Sales · Texas"
      heroEyebrow="Any condition · No repairs · No staging"
      headline={<>Sell Your Texas House <em>As-Is</em> — No Repairs, No Cleaning</>}
      heroIntro="You shouldn't have to spend $20,000 fixing up a house just to sell it. We buy Texas homes in any condition — leaking roofs, outdated kitchens, foundation issues, fire or water damage, years of deferred maintenance. Get a fair written offer in 24 hours without touching a thing."
      detailEyebrow="Selling as-is in Texas?"
      ...
      faqItems={FAQ}
      ctaHeadline={<>Sell your Texas house <em>as-is</em> — get a fair offer today.</>}
    />
  );
}
